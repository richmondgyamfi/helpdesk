				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<!-- <td><a href="admin_message.php"><?php echo $message_topic['studid']; ?> <br> <b><?php echo $message_topic['topic']; ?></b> <br> <?php echo $message_topic['message_sent']; ?></a></td> -->
							<td><a style="color: black;" href="admin_message.php?id=<?php echo $message_topic['id'];?>"><?php echo $message_topic['studid']; ?> <br> <b><?php echo $message_topic['topic']; ?></b> <br> <?php echo $message_topic['message_sent']; ?></a></td> 
